...
export const projects: IProjectCard[] = [

	{
		...
		github: "https://github.com/angelurrutdev/spotify-clone-transitions",
	...
	},
	{
		...
		github: "https://github.com/angelurrutdev/guia-github-git",
		className: 'lg:row-span-3 xl:col-span-4',
		isPrivate: true,
		index: 2,
	...
	{
		id: uuid(),
		project_name: 'Generador de Contraseñas',
		...
		github: 'https://github.com/angelurrutdev/generator-password',
		className: 'lg:row-span-3 xl:col-span-4',
		isPrivate: true,
		index: 3,
